###Environment and dependencies: Python 3.6.10 conda 4.7.12 cuda 10.1 Keras 2.3.1 tensorflow 2.3.0 numpy 1.16.2 #It is possible that with higher versions data cannot be created properly
## Curriculum Learning
